...
export const MENU_THEME_LIST = {
    artist: [
        ...
        {
            title: 'Lin 1',
            cardArtist: require('../assets/images/LisTheme/card_artist/card_theme_lin1.jpg'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/img-background_lin1.jpg'),
                colorPrimary: '#D08011',
                textHover: '#F59D22',
                playerBg: '#4C473E',
        ...
        {
            title: 'Lin 2',
            cardArtist: require('../assets/images/LisTheme/card_artist/card_theme_lin2.jpg'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/img-background_lin2.jpg'),
                colorPrimary: '#BBB9C4',
                textHover: '#6F1F89',
                layoutBg: 'tranparent',
        ...
        {
            title: 'Lin 3',
            cardArtist: require('../assets/images/LisTheme/card_artist/card_theme_lin3.jpg'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/img-background_lin3.jpg'),
                colorPrimary: '#8D22C3',
                textHover: '#8D22C3',
                layoutBg: 'tranparent',
        ...
        {
            title: 'Lin 4',
            cardArtist: require('../assets/images/LisTheme/card_artist/card_theme_lin4.jpg'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/img-background_lin4.jpg'),
                colorPrimary: '#1A3570',
                textHover: '#4C7CFF',
                layoutBg: 'tranparent',
        ...
        {
            title: 'Lin 5',
            cardArtist: require('../assets/images/LisTheme/card_artist/card_theme_lin5.jpg'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/img-background_lin5.jpg'),
                colorPrimary: '#EFEDEB',
                textHover: '#AC3E82', 
                layoutBg: 'tranparent',
                layoutHeaderBg: 'rgb(241, 221, 216, 0.8)',
